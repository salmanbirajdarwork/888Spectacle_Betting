...
class MatchViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        ...
        if self.action == 'retrieve':                     #retrieve: Return the given match
    ...
    def get_queryset(self):
        """
        Restricts the returned queries by filtering against
    ...
    def create(self, request):                     #   Create a new match instance or update odds
